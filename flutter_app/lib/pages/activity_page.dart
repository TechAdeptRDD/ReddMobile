      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          bottom: const TabBar(
            ...
            tabs: [
              Tab(text: "LIVE FEED", icon: Icon(Icons.dynamic_feed)),
              Tab(text: "VELOCITY LEADERBOARD", icon: Icon(Icons.leaderboard))
            ],
          ),
        ),
        body: BlocBuilder<ActivityBloc, ActivityState>(
          builder: (context, state) {
            ...
            if (state is ActivityLoaded) {
                  ...
                  liveFeedItems.add(Card(
                    ...
                    child: ListTile(
                      ...
                      leading: CircleAvatar(
                          ...
                          backgroundImage: cid != null && cid.isNotEmpty
                              ? NetworkImage(
                                  "https://gateway.pinata.cloud/ipfs/$cid")
                              : null,
                          child: (cid == null && isRegistration)
                              ? const Icon(Icons.person, color: Colors.grey)
                              : (!isRegistration
                                  ? const Icon(Icons.chat_bubble,
                                      color: Color(0xFFE31B23))
                                  : null)),
                      title: Text(isRegistration ? "@$username" : "Network Tip",
                          ...
                          child: Text(
                              ...
                              style: TextStyle(
                                  color: isRegistration
                                      ...
                                      : Colors.grey,
                                  fontSize: 13,
                                  fontStyle: isRegistration
                                      ? FontStyle.normal
                                      : FontStyle.italic))),
                      trailing: isRegistration
                          ? IconButton(
              ...
              // Sort leaderboard
              var sortedTippers = topTippers.entries.toList()
                ...
                children: [
                  ...
                  RefreshIndicator(
                    ...
                    child: ListView(
                        ...
                        children: liveFeedItems.isEmpty
                            ? [
                                const Center(
                                    child: Padding(
                                        padding: EdgeInsets.all(20),
                                        child: Text(
                                            "Listening for OP_RETURN data...",
                                            style:
                              ...
                              leading: CircleAvatar(
                                  ...
                                  child: Text("#${index + 1}",
                                      style: const TextStyle(
                                          ...
                                          fontWeight: FontWeight.bold))),
                              title: Text(
                                  "${entry.key.substring(0, 10)}...${entry.key.substring(entry.key.length - 4)}",
                                  style: const TextStyle(
                                      color: Colors.white,
