...
class VaultScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const String appVersion = String.fromEnvironment('APP_VERSION', defaultValue: 'v0.2.0-Alpha');
    ...
    void showMnemonicDialog() {
      ...
      showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          title: const Text("New Wallet Generated", style: TextStyle(color: Color(0xFFE31B23))),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              const Text("Write this down safely:", style: TextStyle(color: Colors.white70)),
      ...
      body: Stack(
        children: [
          Center(
            child: Column(
              ...
              children: [
                ...
                const Text("SECURE VAULT", style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold, letterSpacing: 4)),
                ...
                ElevatedButton(
                  ...
                  child: const Text("UNLOCK WALLET", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                ),
          ...
          Positioned(
            ...
            right: 0,
            child: Center(
              child: Text("ReddMobile $appVersion", style: TextStyle(color: Colors.white.withOpacity(0.3), fontSize: 10)),
            ),
          ),
        ],
      ),
